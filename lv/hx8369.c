...
// void lvgl_flush_cb(lv_disp_drv_t *drv, const lv_area_t *area, lv_color_t
// *color_map)
// {
//     esp_lcd_panel_handle_t panel_handle =
//     (esp_lcd_panel_handle_t)drv->user_data; int offsetx1 = area->x1; int
//     offsetx2 = area->x2; int offsety1 = area->y1; int offsety2 = area->y2;
